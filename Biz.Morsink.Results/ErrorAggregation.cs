...
namespace Biz.Morsink.Results
{
    ...
    {
        private static readonly ConcurrentDictionary<Type, Delegate> Aggregators = new ConcurrentDictionary<Type, Delegate>();
...
#nullable disable
        ...
        public static Func<E, E, E> Get<E>()
        {
            ...
            return (Func<E, E, E>)Aggregators.GetOrAdd(typeof(E), _ => new Func<E, E, E>((e, _2) => e));
        }
