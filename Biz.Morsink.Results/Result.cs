...
namespace Biz.Morsink.Results
{
    ...
    public static class Result
    {
        ...
        public static Result<R, E> Apply<T, U, R, E>(this (Result<T, E>, Result<U, E>) results, Func<T, U, R> f,
#if NET6_0_OR_GREATER        
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
        ...
        #region Enumerables
        #region Filtering
        public static IEnumerable<T> DropFailures<T, E>(this IEnumerable<Result<T, E>> results,
#if NET6_0_OR_GREATER
        ...
        public static IEnumerable<(K, V)> DropFailures<K, V, E>(this IEnumerable<(K, Result<V, E>)> results, 
#if NET6_0_OR_GREATER
            Action<E>? onError = null)
#else
            Action<E> onError = null)
        ...
        public static IEnumerable<KeyValuePair<K, V>> DropFailures<K, V, E>(this IEnumerable<KeyValuePair<K, Result<V, E>>> results,
#if NET6_0_OR_GREATER
            Action<E>? onError = null)
#else
            Action<E> onError = null)
#endif
        {
            foreach(var x in results)
                if (x.Value is ISuccess<V> s)
                    yield return new KeyValuePair<K, V>(x.Key, s.Value);
        ...
        public static Result<ImmutableArray<T>, E> Sequence<T, E>(this IEnumerable<Result<T, E>> results,
#if NET6_0_OR_GREATER
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
        ...
        public static Result<ImmutableList<T>, E> SequenceList<T, E>(this IEnumerable<Result<T, E>> results, 
#if NET6_0_OR_GREATER
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
        ...
        public static Result<IImmutableSet<T>, E> SequenceSet<T, E>(this IEnumerable<Result<T, E>> results,
#if NET6_0_OR_GREATER
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
        ...
        public static Result<ImmutableHashSet<T>, E> SequenceHashSet<T, E>(this IEnumerable<Result<T, E>> results,
#if NET6_0_OR_GREATER
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
        ...
        public static Result<ImmutableSortedSet<T>, E> SequenceSortedSet<T, E>(this IEnumerable<Result<T, E>> results,
#if NET6_0_OR_GREATER
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
        ...
        public static Result<C, E> SequenceSet<T, E, C>(this IEnumerable<Result<T, E>> results, Func<IEnumerable<T>, C> collector, 
#if NET6_0_OR_GREATER
            Func<E, E, E>? errorAggregator = null)
#else
            Func<E, E, E> errorAggregator = null)
...
#else
        public static bool TryGetValue<T, E>(this Result<T, E> result, out T val)
#endif
            where T : class
        {
...
#else
        public delegate bool TryParseDelegateCls<T>(string val, out T output) where T : class;

        public delegate bool TryParseDelegateStr<T>(string val, out T? output) where T : struct;
#endif
        ...
        public static R Switch<T, E, R>(this IResult<T, E> result, Func<T, R> onSuccess, Func<E, R> onFailure)
            => result is ISuccess<T> suc 
                ? onSuccess(suc.Value) 
                : result is IFailure<E> fai 
                    ? onFailure(fai.Error) 
    ...
    public abstract class Result<T, E> : IResult<T, E>
    {
        ...
        public class Success : Result<T, E>, ISuccess<T>
        {
            ...
            public override Result<T, E> Where(Func<T, bool> predicate, E error)
                => predicate(Value) ? (Result<T, E>) this : error;
            public override Result<T, E> Where(Func<T, bool> predicate, Func<E> errorCreator)
                => predicate(Value) ? (Result<T,E>) this : errorCreator();
